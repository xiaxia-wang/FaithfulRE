...
def main(data_dir, exps_dir, model, process):
    ...
    if process == "train":
        ...
        experiment.extract_rules_time_sm(1e-3) # print rule extraction time to output
        experiment.extract_rules_time_sm(1e-2)
        experiment.extract_rules_time_sm(1e-1)
